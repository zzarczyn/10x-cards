...
- Algorytm powtórek: Aplikacja nie posiada trybu "Nauki" ani harmonogramu powtórek.
...
- Organizacja: Brak kategorii, tagów czy podziału na talie (użytkownik widzi jednocześnie wszystkie swoje fiszki).
- Społeczność: Brak współdzielenia fiszek. Brak profili publicznych.
...
- Opis: Jako użytkownik, chcę otrzymać propozycje fiszek na podstawie wklejonego tekstu, aby nie wymyślać ich samodzielnie.
- Kryteria akceptacji:
